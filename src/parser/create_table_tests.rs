...
vec![
    ColumnDef {name: String::from("Id"), data_type: DataType::new("INT", Some(10), None), ..Default::default()},
    ColumnDef {name: String::from("Title"), data_type: DataType::new("VARCHAR", Some(3), None), ..Default::default()},
])]
#[case("CREATE TABLE IF NOT EXISTS\n Test {Id FLOAT(10)};", "Test",
vec![
ColumnDef {name: String::from("Id"), data_type: DataType::new("FLOAT", Some(10), None), ..Default::default()},
])]
#[case(" CREATE TABLE IF NOT EXISTS\n Test \n{\nId FLOAT(2)\n,}\n;\n", "Test",
vec![
ColumnDef {name: String::from("Id"), data_type: DataType::new("FLOAT", Some(2), None), ..Default::default()},
])]
#[case(" create table if not exists\n Test \n{\nId FLOAT(3)\n,}\n;\n", "Test",
vec![
ColumnDef {name: String::from("Id"), data_type: DataType::new("FLOAT", Some(3), None), ..Default::default()},
])]
#[case(" create table if not exists\n Schema.Test \n{\nId FLOAT(1)\n,}\n;\n",
TableRef::new("Test", Some("Schema"), None),
vec![
ColumnDef {name: String::from("Id"), data_type: DataType::new("FLOAT", Some(1), None), ..Default::default()},
])]
...
TableRef::new("Test", Some("Schema"), Some("jlk asdf19(**")),
vec![
ColumnDef {name: String::from("Id"), data_type: DataType::new("FLOAT", Some(9), None), ..Default::default()},
])]
#[case(" create table if not exists\n Test \n{\nId FLOAT(2)\n,}\n;\n",
...
vec![
ColumnDef {name: String::from("Id"), data_type: DataType::new("FLOAT", Some(2), None), ..Default::default()},
ColumnDef {name: String::from("Price"), data_type: DataType::new("FLOAT", Some(3), None), ..Default::default()},
ColumnDef {name: String::from("Notes"), data_type: DataType::new("TEXT", Some(10), None), ..Default::default()},
])]
...
ColumnDef {name: String::from("Price"), data_type: DataType::new("FLOAT", Some(2), None), ..Default::default()},
